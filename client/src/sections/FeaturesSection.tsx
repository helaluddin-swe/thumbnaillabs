...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Features" text2="Why use our App?" text3="Create stunning thumbnails that get clicks, without the hassle." />
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                    ThumbAI helps you build faster by transforming thumbnail design vision with fully youtube videos.
                </motion.p>
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <h3 className="text-[24px]/7.5 text-slate-300 font-medium mt-6">Better Thumbnail design with highest CTA </h3>
                        <p className="text-slate-300 mt-2">ThumbAI empowers you to build beautifully and scale effortlessly.</p>
